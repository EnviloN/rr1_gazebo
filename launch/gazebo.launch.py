...
def generate_launch_description():
    ...
    rr1_gazebo_pkg = get_package_share_directory(RR1_GAZEBO_PKG)
    gazebo_pkg = get_package_share_directory(GAZEBO_PKG)

    # Folder with models used in the world description
    world_models = os.path.join(rr1_gazebo_pkg, 'worlds', 'models')
    ...
    launch_argument = DeclareLaunchArgument(
        'world',
        default_value=[os.path.join(rr1_gazebo_pkg, 'worlds', WORLD_FILE), ''],
